...
replace github.com/kyverno/policy-reporter-plugins/sdk/api v0.0.0 => github.com/kyverno/policy-reporter-plugins/sdk/api v0.0.0-20240403084424-e8de40bf5c80
